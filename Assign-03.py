...
# it then tells them if their allowed to vote
...
def main():
    ...
    # An try catch to catch any errors if
    # they enter a string for country_string
    try:
        ...
        if country_num == constants.CANADA:
            try:
                # A try catch to catch if they
                # entered a string for the users age
                ...
                # A Elif statement to see if the users age is
                # greater than or equal to 18 and is less than or equal to 122
                elif (
        ...
        # If statement to see if you can vote in Austria
            ...
            try:
                ...
                # A Elif statement to see if the users age is greater
                # than or equal to 16 and is less than or equal to 122
                elif (
        ...
        # If statement to see if you can vote in Bahrain
            ...
            try:
                ...
                # A Elif statement to see if the users age is
                # greater than or equal to 20 and is less than or equal to 122
                elif (
